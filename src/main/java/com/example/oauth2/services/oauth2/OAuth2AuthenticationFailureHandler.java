...
public class OAuth2AuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        // this is called when the authorization request is not found... after that, the removeAuthorizationRequestCookies will be called.
        // this often happens when the app is stopped while you're trying to authenticate...
